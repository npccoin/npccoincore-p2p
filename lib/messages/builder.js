...
function builder(options) {
  ...
  if (!options.network) {
    options.network = npccoincore.Networks.defaultNetwork;
  }

  options.Block = options.Block || npccoincore.Block;
  options.BlockHeader = options.BlockHeader || npccoincore.BlockHeader;
  options.Transaction = options.Transaction || npccoincore.Transaction;
  options.MerkleBlock = options.MerkleBlock || npccoincore.MerkleBlock;
  options.MnListDiff = options.MnListDiff || npccoincore.MnListDiff;
